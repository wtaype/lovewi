import{$ as a}from"./widev-BAfp7xMP.js";import{l as e,c as n,d as t,a as s,v}from"./wii-a5uC_Ctk.js";function r(){const o=new Date;return`
  ...
  `}a("body").append(r());a("head").append('<style>:root{--bgim:url("/lovewi/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>');const l=()=>`<div class="movil_divider"></div>${a(".nv_right").html()}`;a("body").append(`<div class="movil_overlay"></div>
