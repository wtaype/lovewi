...
</div>`},v=a=>{if(!(a.musica&&a.musica.trim()))return;l=new Audio(a.musica),l.loop=!0,l.volume=.5;const e=()=>{l.play().then(()=>{s("#plMusica").addClass("playing"),s("#plMusicaTxt").text("Sonando")}).catch(()=>{})},c=()=>{s("#plAutoplay").fadeOut(400,function(){s(this).remove()}),s("#plMujer").css("display","").hide().fadeIn(600),e()};s(document).on("click.plMujer","#plAutoplay",c),p.push(()=>s(document).off("click.plMujer","#plAutoplay")),s(document).on("click.plMujer","#plMusica",()=>{l&&(l.paused?e():(l.pause(),s("#plMusica").removeClass("playing"),s("#plMusicaTxt").text("Pausado")))}),p.push(()=>s(document).off("click.plMujer","#plMusica"))},j=()=>{l&&(l.pause(),l.src="",l=null),p.forEach(a=>a()),p=[]};export{j as cleanup,v as init,_ as render};
