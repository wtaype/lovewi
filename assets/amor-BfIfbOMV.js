import{$ as s}from"./widev-BAfp7xMP.js";let l=null,p=[];const n=["💕","💗","💖","💘","💝","❤️","🩷","✨","🌸"],m=(a=25)=>Array.from({length:a},(i,o)=>{const c=n[o%n.length],e=1.5+Math.random()*2.5,t=6+Math.random()*14,r=Math.random()*8;return`<span style="left:${Math.random()*100}%;font-size:${e}vh;animation-duration:${t}s;animation-delay:${r}s">${c}</span>`}).join(""),_=a=>{const i=a.musica&&a.musica.trim();return`
${i?`
