import{j as c}from"./vendor-gzd0YkcT.js";import{i as s}from"./main-IZC3CXfk.js";const t=()=>`
    ...
    <section class="desc_testimonios">
      <div class="testimonios_wrapper">
        <div class="section_header">
          ...
          <p>Miles de personas ya confían en ${s}</p>
        </div>
    ...
    <section class="desc_cta">
      <div class="cta_wrapper">
        <div class="cta_content">
          ...
          <p>Únete a miles de personas que ya usan ${s} para compartir amor y emociones</p>
...
`,d=()=>{console.log(`✅ Descubre de ${s} cargado`),o()};function o(){const i=new IntersectionObserver(e=>{e.forEach(a=>{a.isIntersecting&&a.target.classList.add("visible")})},{threshold:.1});c(".feature_item, .paso_card, .testimonio_card, .stat_box, .visual_card").each(function(){i.observe(this)})}const n=()=>{console.log("🧹 Descubre limpiado")};export{n as cleanup,d as init,t as render};
