import{j as a}from"./vendor-gzd0YkcT.js";import{l as t,c as r,d as l,a as o,v as e}from"./wii-CmqZrdN0.js";function i(){const s=new Date;return`
  ...
  `}a("body").append(i());a("head").append('<style>:root{--bgim:url("/lovewi/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>');a(".wimenu").on("click",function(){a(".wiheader").toggleClass("movil"),a(this).find("i").toggleClass("fa-bars fa-times")});const n=()=>{const s=a(".hero_imagen");s.length?s.append('<img src="/lovewi/amor.webp" alt="Lovewi - Mensajes de Amor">'):requestAnimationFrame(n)};n();console.log(`✅ ${o} : ${e}`);export{i as footer};
