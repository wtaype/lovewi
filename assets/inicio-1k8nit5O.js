import{j as a}from"./vendor-gzd0YkcT.js";import{c as s,v as i}from"./main-DkHKdfdH.js";import"./main-CWyf82FG.js";const r=()=>`
  <div class="inicio_container">
    ...
    <section class="benefits">
      <h2 class="section_title"><i class="fas fa-sparkles"></i> ¿Por qué usar ${s}?</h2>
    ...
    <section class="cta">
      ...
      <p>Únete a miles de personas que expresan sus sentimientos con <strong>${s}</strong></p>
...
`,n=()=>{a('a[href="#ejemplos"]').on("click",function(e){e.preventDefault(),a("html, body").animate({scrollTop:a("#ejemplos").offset().top-80},600)}),console.log(`💌 ${s} ${i} - Inicio cargado`)},t=()=>{a('a[href="#ejemplos"]').off(),console.log("🧹 Inicio limpiado")};export{t as cleanup,n as init,r as render};
