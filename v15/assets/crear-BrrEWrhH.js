const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/agregar-kDRbzr-P.js","assets/vendor-gzd0YkcT.js","assets/firebase-D9gaOqhL.js","assets/wii-CmqZrdN0.js","assets/firebase-XkXceBzL.js","assets/widev-CQFaY4xL.js","assets/agregar-XgbRNuCR.css","assets/wiloves-bFAakB4G.js","assets/publico-DmfCHdZk.js"])))=>i.map(i=>d[i]);
import{_ as m}from"./preload-helper-DOlojtc1.js";import{j as a}from"./vendor-gzd0YkcT.js";import{N as l,f as h,c as M,b as n,g as I}from"./widev-CQFaY4xL.js";import{p as d,a as T,g as E,b as j,c as D}from"./parametros-scKfFSaG.js";const v=()=>!!I("wiSmile"),f=new Map,L=r=>{const e=d[r]?.musicas||[];return e.length?`<div class="cr_chips">
    ${e.map(u=>`<label class="cr_chip" style="--chip:${d[r].x}"><input type="radio" name="crMusChip" value="${u.u}"><span><i class="fas fa-music"></i> ${u.n}</span></label>`).join("")}
          ...
          <div class="cr_campo">
            ...
            <div class="cr_select">
              <select id="selPlantilla">
                ${Object.keys(d).map((r,e)=>`<option value="${r}"${e?"":" selected"}>${d[r].e} ${r}</option>`).join("")}
              </select>
