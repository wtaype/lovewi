import{$ as a}from"./widev-CiGWk2mv.js";import{l as e,c as n,d as t,a as s,v}from"./wii-D67iYGq9.js";function r(){const o=new Date;return`
  ...
  `}a("body").append(r());a("head").append('<style>:root{--bgim:url("/lovewi/v17/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>');const l=()=>`<div class="movil_divider"></div>${a(".nv_right").html()}`;a("body").append(`<div class="movil_overlay"></div>
