import{db as d}from"./firebase-B1Sf94_m.js";import{n as u,b as _}from"./firebase-CJ9Bz22x.js";import{$ as r,d as c,s as m,M as e,b as v,g as b}from"./widev-CiGWk2mv.js";import{rutas as h}from"./ruta-DLdVyCIT.js";import"./wii-D67iYGq9.js";import"./preload-helper-D-8tP3xx.js";const l=()=>b("wiSmile")||{},U=()=>{const a=l();if(!a.email)return location.replace("/"),"";const s=a.nombre||"",i=a.apellidos||"",p=a.usuario||"",f=a.email||"",o=a.rol||"smile",n=a.uid||"",t=a.imagen||"./smile.avif";return((s[0]||"")+(i[0]||"")).toUpperCase(),`
  <div class="prf_wrap">
