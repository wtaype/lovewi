import{auth as y,db as u}from"./firebase-B1Sf94_m.js";import{a as I,c as h,d as A,b,q as L,w as T,g as S,s as f}from"./firebase-CJ9Bz22x.js";import{$ as i,N as n,c as l,g as U,d as p}from"./widev-CiGWk2mv.js";import"./wii-D67iYGq9.js";const e="wiAudios",d="wiImg",m=()=>U("wiSmile")?.email||y.currentUser?.email||"",g=async s=>{const t=m();if(!t)return[];const r=L(h(u,s),T("email","==",t));return(await S(r)).docs.map(c=>({id:c.id,...c.data()})).sort((c,o)=>(o.creado?.seconds||0)-(c.creado?.seconds||0))},v=async(s,t,r)=>{const a=m();return a?(await I(h(u,s),{email:a,titulo:t,src:r,creado:f(),actualizado:f()})).id:null},$=async(s,t)=>{await A(b(u,s,t))},B=()=>g(e),D=()=>g(d),x=(s,t)=>`
