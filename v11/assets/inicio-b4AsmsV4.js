import{j as a}from"./vendor-gzd0YkcT.js";import{i,j as c,v as t,y as r}from"./main-BVtyqlJy.js";import"./main-4vpj1cqS.js";const p=()=>`
  <div class="inicio">
    <section class="hero">
      ...
      <div class="hero_contenido">
        <div class="hero_badge">
          ...
          <span>San Valentín ${r()} y Más</span>
        </div>
      ...
      <div class="hero_imagen">
        <img src="/lovewi/v11/amor.webp" alt="Lovewi - Mensajes de Amor" loading="lazy">
    ...
    <section class="testimonios">
      ...
      <div class="testimonios_grid">
        ...
        <div class="testimonio" data-vista="test2">
          ...
          <p>"Usé ${i} para mi aniversario y fue un éxito total. Super fácil de usar y los temas son preciosos 🎉"</p>
          <div class="testimonio_autor">
            <strong>Ana R.</strong>
    ...
    <section class="cta_final">
      <div class="cta_contenido">
        ...
        <p>Únete a miles de personas que expresan sus sentimientos con <strong>${i}</strong></p>
...
`,v=()=>{[".caracteristica",".ejemplo",".paso",".testimonio"].forEach(s=>{a(s).each((e,o)=>c(o,()=>a(o).addClass("visible")))}),a('a[href^="#"]').on("click",function(s){const e=a(this.getAttribute("href"));e.length&&(s.preventDefault(),a("html, body").animate({scrollTop:e.offset().top-80},600))}),setInterval(()=>{const s=a('<i class="fas fa-heart floating-heart"></i>'),e=Math.random()*90+5;s.css({left:`${e}%`,animationDuration:`${Math.random()*2+3}s`}),a(".hero_decoracion").append(s),setTimeout(()=>s.remove(),5e3)},2e3),console.log(`💌 ${i} ${t} - Inicio profesional cargado`)},m=()=>{a('a[href^="#"]').off("click"),a(".floating-heart").remove(),console.log("🧹 Inicio limpiado")};export{m as cleanup,v as init,p as render};
