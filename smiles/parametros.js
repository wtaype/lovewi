...
const M = {
  ...
  Amistad:     { c:'amistad',     i:'fa-user-group',         k:'Amistad',     x:'#6b8aff', e:'💙', b:'linear-gradient(135deg,#6b8aff,#b3c1ff,#f0f3ff)',  d:'Celebra la amistad verdadera con mensajes del corazón',                 ej:'Gracias por estar siempre, por las risas y por ser mi mejor amigo 💙',                     mu:null },
...
// ✅ Compatibilidad directa (crear.js, header.js, etc.)
...
// ✅ Buscar nombre por carpeta: 'amor' → 'Amor'
...
// ✅ Normalizar datos de Firebase → formato render
const normalizar = (d) => {
