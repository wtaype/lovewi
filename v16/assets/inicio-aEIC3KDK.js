import{a as i}from"./wii-a5uC_Ctk.js";import{$ as a,e as t,y as c}from"./widev-CiGWk2mv.js";const l=()=>`
  <div class="inicio">
    <section class="hero">
      ...
      <div class="hero_contenido">
        <div class="hero_badge">
          ...
          <span>San Valentín ${c()} y Más</span>
        </div>
...
`,d=()=>{[".caracteristica",".ejemplo",".paso",".testimonio"].forEach(s=>{t(s,e=>a(e).addClass("visible"))}),a('a[href^="#"]').on("click",function(s){const e=a(this.getAttribute("href"));e.length&&(s.preventDefault(),a("html, body").animate({scrollTop:e.offset().top-80},600))});const o=setInterval(()=>{const s=a('<i class="fas fa-heart floating-heart"></i>'),e=Math.random()*90+5;s.css({left:`${e}%`,animationDuration:`${Math.random()*2+3}s`}),a(".hero_decoracion").append(s),setTimeout(()=>s.remove(),5e3)},2e3);window._wiHeartInterval=o},p=()=>{clearInterval(window._wiHeartInterval),a('a[href^="#"]').off("click"),a(".floating-heart").remove()};export{p as cleanup,d as init,l as render};
