import{j as i}from"./vendor-gzd0YkcT.js";import{auth as y,db as u}from"./firebase-D9gaOqhL.js";import{k as I,c as h,l as A,d as b,q as L,w as T,b as S,a as f}from"./firebase-XkXceBzL.js";import{N as n,c as l,g as U,b as p}from"./widev-CQFaY4xL.js";import"./wii-CmqZrdN0.js";const e="wiAudios",d="wiImg",m=()=>U("wiSmile")?.email||y.currentUser?.email||"",g=async s=>{const t=m();if(!t)return[];const r=L(h(u,s),T("email","==",t));return(await S(r)).docs.map(c=>({id:c.id,...c.data()})).sort((c,o)=>(o.creado?.seconds||0)-(c.creado?.seconds||0))},v=async(s,t,r)=>{const a=m();return a?(await I(h(u,s),{email:a,titulo:t,src:r,creado:f(),actualizado:f()})).id:null},k=async(s,t)=>{await A(b(u,s,t))},D=()=>g(e),j=()=>g(d),x=(s,t)=>`
